...
struct Matriz *ColocarArriba (struct Matriz *, int, int, int, int);
struct Matriz *ColocarAbajo (struct Matriz *, int, int, int, int);
struct Matriz *ColocarIzquierda (struct Matriz *, int, int, int, int);
struct Matriz *ColocarDerecha (struct Matriz *, int, int, int, int);
